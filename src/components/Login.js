...
const Login = () => {
  ...
  return (
    <div className="w-full h-full pb-2 md:pb-4 bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/c31c3123-3df7-4359-8b8c-475bd2d9925d/15feb590-3d73-45e9-9e4a-2eb334c83921/IN-en-20231225-popsignuptwoweeks-perspective_alpha_website_large.jpg')]">
      ...
      <form className='bg-black bg-opacity-75 p-4 md:p-16 flex flex-col gap-6 w-full md:w-[540px]'>
        <p className='text-xl text-white font-bold'>{isSignInForm ? "Sign In": "Sign Up"}</p>
        {!isSignInForm && <input type='text' id='fullName' placeholder='full name' className='bg-[#333] rounded-lg text-sm text-white block w-full p-2.5 border-1 focus:outline-none focus:border-blue-500 ' />}
        <input type='text' id='email' placeholder='email or phone number' className='bg-[#333] rounded-lg text-sm text-white block w-full p-2.5 border-1 focus:outline-none focus:border-blue-500 ' />
        <input type='text' id='password' placeholder='password' className='bg-[#333] rounded-lg text-sm text-white block w-full p-2.5 border-1 focus:outline-none focus:border-blue-500 ' />
        <button type='submit' className='p-2 bg-[#e50914] rounded-lg text-white font-bold'>{isSignInForm ? "Sign In": "Sign Up"}</button>
